...
public abstract class Application {
    ...
    protected abstract Group createContent(); //durch group ersetzen (array list), vorher ArrayList<Button>
    ...
    protected void handleEvent(Event e) {
        if (e instanceof EventWindowCloseRequest) {
            ...
            controls.handleEvent(scaledEvent); // durch controls.handleEvent(scaledEvent) ersetzen, vorher: controls.forEach(b -> b.handleEvent(scaledEvent));
        }
    ...
    protected void paint(Canvas canvas) {
        ...
        controls.paint(canvas); // durch controls.paint(canvas) ersetzen, vorher: controls.forEach(b -> b.paint(canvas));
        window.requestFrame();
    }
